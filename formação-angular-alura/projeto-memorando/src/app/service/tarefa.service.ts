...
export class TarefaService {
  ...
  listar(): void {
    ...
    this.http.get<Tarefa[]>(this.API, { params }).subscribe((tarefas) => {
      let tarefasTemporais = this.tarefasSubject.getValue()
      tarefasTemporais = tarefasTemporais.concat(tarefas)
      this.tarefasSubject.next(tarefasTemporais)
    });
  }
